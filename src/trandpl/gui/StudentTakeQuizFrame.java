...
public class StudentTakeQuizFrame extends javax.swing.JFrame {
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
     ...
     private double getPercentage()
     {
       ...
       private void sendMail(ResultsPojo obj){
	...
	prop.put("mail.smtp.host", "smtp.gmail.com");
        ...
        try {
            ...
            InternetAddress[]recipients=InternetAddress.parse(CurrentUser.getUserId());
            message.setRecipients(
                    Message.RecipientType.TO,
                    recipients
            );
            message.setSubject("Notification From Training And Placement Application");
            message.setText("Hello "+CurrentUser.getName()+"\n"
                +"You got "+obj.getPercentage()+"% in "+obj.getjId()+"\n"
                +"Warm Regards\n"
