 ...
 * @author hmayw
 */
public class AdminViewQualifiedParticipants extends javax.swing.JFrame {

    /**
     * Creates new form AdminViewQualifiedParticipants
     */
    private List<ParticipantPojo>list;
    private DefaultTableModel model;
    
    public AdminViewQualifiedParticipants() {
        initComponents();
     ...
     private void loadData(){
          try{
            list=ParticipantsDAO.getQualifiedParticipants();
            if(list.isEmpty())
            {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 62, 996, 208));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(239, 367, 759, 250));

        tblAllParticipants.setFont(new java.awt.Font("Cambria", 0, 18)); // NOI18N
        tblAllParticipants.setText("View All Qualified Participants ");
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 371, 206, 202));
        ...
        jPanel1.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(91, 657, -1, -1));
        ...
        jPanel1.add(btnLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(931, 657, -1, -1));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(36, 637, 970, 10));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewQualifiedParticipants.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
